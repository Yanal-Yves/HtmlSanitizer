...
{
    /// <summary>
    /// Xml5 markup formatter. Identical to <see cref="XmlMarkupFormatter"/> except for &lt; and &gt; which are
    /// encoded in attribute values.
    /// </summary>
    public class XmlFormatter : XmlMarkupFormatter
    {
        /// <summary>
        /// An instance of <see cref="XmlFormatter"/>.
        /// </summary>
        new public static readonly XmlFormatter Instance = new();
